...
export default async function Home() {
  ...
  return (
    <div className="min-h-screen bg-linear-to-br from-gray-900 via-gray-800 to-black relative overflow-hidden">
      ...
      <div className="container mx-auto px-4 py-16 relative z-10 min-h-screen flex items-center">
        <div className="text-center max-w-4xl mx-auto w-full">
          {/* Logo/Title */}
          <div className="mb-8 animate-fade-in mt-20">
          ...
          <div className="mt-16 animate-fade-in-delay-4">
            <p className="text-gray-500 text-sm italic">
              "Droopy never sleeps, and neither does your inventory."
            </p>
          </div>
        </div>
      </div>
